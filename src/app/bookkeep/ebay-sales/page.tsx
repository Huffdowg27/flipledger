...
export default function EbaySalesPage() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    const res = await fetch(`/api/data/ebay-sales?startDate=${dateRange.startDate}&endDate=${dateRange.endDate}${marketplaceParam}`);
  ...
  return (
    <div>
      <PageHeader title="eBay Sales" subtitle="Bookkeeping > eBay Sales (MFN)" dateRange={dateRange} onDateRangeChange={setDateRange}
